...
def _parse_element_v2(
    ...
    # ── Extract enrichments (generic across all specialist types) ──
...
def _normalize_type_for_resolver(tag: str) -> str:
    ...
    specialist (e.g., "paragraph", "h1", "figure"). This maps PDF/UA tags
    ...
    <unified_document session_id="test" page="1" schema_version="2.0">
        <metadata>
            ...
            <specialists_executed>
                <specialist name="full_text" s3_uri="s3://test/ft.xml"/>
            </specialists_executed>
        </metadata>
        <content_tree>
            <sect id="sect_root">
