#!/usr/bin/env bash
#
# Build and deploy script for remediation-specialist container Lambda
#
# Usage:
#   ./build.sh [OPTIONS]
#
...
ACTION="build-only"
IMAGE_NAME="remediation-specialist"
IMAGE_TAG="latest"
...
if [ "$ACTION" = "update-lambda" ]; then
    read -p "Enter Lambda function name (default: remediation-specialist): " LAMBDA_FUNCTION_NAME
    LAMBDA_FUNCTION_NAME="${LAMBDA_FUNCTION_NAME:-remediation-specialist}"
