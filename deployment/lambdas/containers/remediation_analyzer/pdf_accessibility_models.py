...
def infer_structure_from_flat_regions(
    ...
    def open_section_for_heading(hlevel: int, heading_elem: StructureElement):
        ...
        new_sect = current_sect().add_child(StructureElement(
...
def _map_region_tag(tag: str) -> str:
    ...
    mapping = {
        ...
        "heading": "H1", "paragraph": "P", "image": "Figure", "figure": "Figure",
        "table": "Table", "list": "L", "list_item": "LI", "footer": "Artifact",
        "header": "Artifact", "caption": "Caption", "blockquote": "BlockQuote",
