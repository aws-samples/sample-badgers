...
class AnalyzerFoundation:
    ...
    def _load_configuration(
        ...
        """
        # Try local manifest first - resolve relative to container directory
        # This file is in foundation/, so parent is the container root
        container_dir = Path(__file__).parent.parent
        manifest_path = (
            container_dir / "tools" / f"{analyzer_type}_analyzer" / "manifest.json"
        )
