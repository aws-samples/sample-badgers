"""Editorial Specialist Lambda - S3-based config version with AgentCore Gateway session tracking."""
...
def lambda_handler(event, context):
    """Lambda handler for Editorial Specialist using S3-based configuration."""
    ...
    try:
        ...
        specialist_name = os.environ.get("SPECIALIST_NAME", "editorial_specialist")
...
def _initialize_specialist(
    ...
    specialist.specialist_type = specialist_name or "editorial_specialist"
