"""Full Text Analyzer Lambda - S3-based config version with AgentCore Gateway session tracking."""
...
def lambda_handler(event, context):
    """Lambda handler for Full Text Analyzer using S3-based configuration."""
    try:
        ...
        analyzer_name = os.environ.get("ANALYZER_NAME", "full_text_analyzer")
...
def _initialize_analyzer(
    ...
    analyzer.analyzer_type = analyzer_name or "full_text_analyzer"
    ...
    analyzer._configure_components()  # pylint: disable=protected-access
