"""Handwriting Math Analyzer Lambda - S3-based config version with AgentCore Gateway session tracking."""
...
def lambda_handler(event, context):
    """Lambda handler for Handwriting Math Analyzer using S3-based configuration."""
    try:
        ...
        analyzer_name = os.environ.get("ANALYZER_NAME", "handwriting_math_analyzer")
...
def _initialize_analyzer(
    ...
    analyzer.analyzer_type = analyzer_name or "handwriting_math_analyzer"
