"""Metadata Mads Specialist Lambda - S3-based config version with AgentCore Gateway session tracking."""
...
def lambda_handler(event, context):
    """Lambda handler for Metadata Mads Specialist using S3-based configuration."""
    try:
        ...
        specialist_name = os.environ.get("SPECIALIST_NAME", "metadata_mads_specialist")
...
def _initialize_specialist(
    ...
    specialist.specialist_type = specialist_name or "metadata_mads_specialist"
