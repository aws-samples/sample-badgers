"""Charts Specialist Lambda - S3-based config version with AgentCore Gateway session tracking."""
...
def lambda_handler(event, context):
    ...
    try:
        ...
        specialist_name = os.environ.get("SPECIALIST_NAME", "charts_specialist")
