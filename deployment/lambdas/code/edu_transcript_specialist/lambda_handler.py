"""Educational Transcript Specialist Lambda - S3-based config version with AgentCore Gateway session tracking."""
...
def lambda_handler(event, context):
    """Lambda handler for Charts Specialist using S3-based configuration."""
    ...
    try:
        ...
        specialist_name = os.environ.get("SPECIALIST_NAME", "edu_transcript_specialist")
    ...
    if "image_path" in body:
        ...
        if image_path.startswith("s3://"):
            ...
            try:
                ...
                raise handle_s3_error(e, bucket, key)
...
def _initialize_specialist(
    ...
    specialist.specialist_type = specialist_name or "charts_specialist"
