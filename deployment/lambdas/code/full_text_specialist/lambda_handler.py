"""Full Text Specialist Lambda - S3-based config version with AgentCore Gateway session tracking."""
...
def lambda_handler(event, context):
    """Lambda handler for Full Text Specialist using S3-based configuration."""
    try:
        ...
        specialist_name = os.environ.get("SPECIALIST_NAME", "full_text_specialist")
...
def _initialize_specialist(
    ...
    specialist.specialist_type = specialist_name or "full_text_specialist"
    ...
    # Configure components using public method pattern
    # Note: _configure_components is internal but necessary for manual initialization
    specialist._configure_components()  # pylint: disable=protected-access
