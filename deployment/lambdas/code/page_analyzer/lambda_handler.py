"""Page Analyzer Lambda - S3-based config version with AgentCore Gateway session tracking."""
...
def lambda_handler(event, context):
    """Lambda handler for Page Analyzer using S3-based configuration."""
    try:
        ...
        analyzer_name = os.environ.get("ANALYZER_NAME", "page_analyzer")
        ...
        # Run analysis
        analysis_output = analyzer.analyze(image_data, body.get("aws_profile"))
...
def _initialize_analyzer(
    ...
    analyzer.analyzer_type = analyzer_name or "page_analyzer"
