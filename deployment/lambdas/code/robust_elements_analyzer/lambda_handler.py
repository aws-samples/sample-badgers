"""Robust Elements Analyzer Lambda - S3-based config version with AgentCore Gateway session tracking."""
...
def lambda_handler(event, context):
    """Lambda handler for Robust Elements Analyzer using S3-based configuration."""
    try:
        ...
        analyzer_name = os.environ.get("ANALYZER_NAME", "robust_elements_analyzer")
...
def _initialize_analyzer(
    ...
    analyzer.analyzer_type = analyzer_name or "robust_elements_analyzer"
