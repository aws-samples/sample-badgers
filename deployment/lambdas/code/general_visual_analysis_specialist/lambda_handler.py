"""General Visual Analysis Specialist Lambda - S3-based config version with AgentCore Gateway session tracking."""
...
def lambda_handler(event, context):
    """Lambda handler for General Visual Analysis Specialist using S3-based configuration."""
    ...
    try:
        ...
        specialist_name = os.environ.get(
            "SPECIALIST_NAME", "general_visual_analysis_specialist"
        )
...
def _initialize_specialist(
    ...
    specialist.specialist_type = specialist_name or "general_visual_analysis_specialist"
