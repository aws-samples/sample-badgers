"""General Visual Analysis Analyzer Lambda - S3-based config version with AgentCore Gateway session tracking."""
...
def lambda_handler(event, context):
    """Lambda handler for General Visual Analysis Analyzer using S3-based configuration."""
    try:
        ...
        analyzer_name = os.environ.get(
            "ANALYZER_NAME", "general_visual_analysis_analyzer"
        )
...
def _initialize_analyzer(
    ...
    analyzer.analyzer_type = analyzer_name or "general_visual_analysis_analyzer"
