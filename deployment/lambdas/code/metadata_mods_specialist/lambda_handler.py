"""Metadata Mods Specialist Lambda - S3-based config version with AgentCore Gateway session tracking."""
...
def lambda_handler(event, context):
    ...
    try:
        ...
        specialist_name = os.environ.get("SPECIALIST_NAME", "metadata_mods_specialist")
...
def _initialize_specialist(
    ...
    specialist.specialist_type = specialist_name or "metadata_mods_specialist"
